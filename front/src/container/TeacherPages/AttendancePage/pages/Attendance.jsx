                            ...
                            <Card className="full-card">
                                <CardHeader>
                                    ...
                                    <div className="btn-actions-pane-right">
                                        <Button type="submit" color="primary" onClick={this.handleSaveFormSubmit}>Save</Button>
                                    </div>
                                </CardHeader>
                                <CardBody>
                                    ...
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <div className="btn-actions-pane-right">
                                                <ButtonGroup>
                                                    <Button color="secondary" onClick={this.handlePrevWeek}>Prev</Button>
                                                    <Button color="warning" onClick={this.handleToday}>Current</Button>
                                                    <Button color="secondary" onClick={this.handleNextWeek}>Next</Button>
                                                </ButtonGroup>
                                            </div>
                                            </CardHeader>
                                        <CardBody>
